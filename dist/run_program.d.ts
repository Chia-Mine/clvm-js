...
export declare function run_program(program: SExp, args: CLVMObject, operator_lookup: TOperatorDict, max_cost?: number | None, pre_eval_f?: TPreEvalF | None): Tuple2<int, CLVMObject>;
