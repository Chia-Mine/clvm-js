...
} & ((op: Bytes | string | number, args: SExp) => Tuple<int, CLVMObject>) & TAtomOpFunctionMap<A> & Record<TBasicAtom, Bytes>;
export declare type TOperatorDictOption = {
    quote_atom: Bytes;
    apply_atom: Bytes;
    unknown_op_handler: typeof default_unknown_op;
};
export declare function OperatorDict<A extends str = ATOMS>(atom_op_function_map: TAtomOpFunctionMap<A> | TOperatorDict, option?: Partial<TOperatorDictOption>): TOperatorDict<A>;
